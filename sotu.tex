...
\bibitem{ren9} WEMO.tech:"CSSでメディアクエリ(Media Queries)の基本的な書き方、記述の意味を理解し、「何となく使う」を卒業する。"\url{https://wemo.tech/839}
...
%1
\lstinputlisting[caption=index.html]{program/index.html}
\newpage
\lstinputlisting[caption=face01.css]{program/face01.css}
\newpage
\lstinputlisting[caption=index.css]{program/index.css}
\newpage
\lstinputlisting[caption=indexmb.css]{program/indexmb.css}
\newpage
\lstinputlisting[caption=indexmbipad.css]{program/indexmbipad.css}
\newpage
\lstinputlisting[caption=ex2.js]{program/ex2.js}
\newpage
\lstinputlisting[caption=nylon.js]{program/nylon.js}
\newpage
\lstinputlisting[caption=page.js]{program/page.js}
\newpage
\lstinputlisting[caption=serviceworker.js]{program/serviceworker.js}
\newpage
\lstinputlisting[caption=manifest.json]{program/manifest.json}
\newpage
\end{document}
